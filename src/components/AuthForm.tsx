    ...
    <div className="w-full h-full flex flex-col items-center py-5 gap-2">
      ...
      <div className="flex items-center gap-8 mt-2  w-full justify-center">
        <button
          ...
          className="flex items-center border-3 px-4 py-2 gap-2 border-gray-400 rounded-full cursor-pointer transition-transform duration-300 hover:scale-105"
        >
          <FcGoogle className="lg:size-5 xl:size-7" />
          <span className="lg:textlg xl:text-xl f-poppins font-semibold">
            Google
          </span>
        </button>
        <button
        ...
        >
          ...
          <span className="lg:text-lg` xl:text-xl f-poppins font-semibold">
            Github
          </span>
        </button>
      </div>
      ...
      <form
        ...
        className="flex flex-col gap-5 w-full lg:px-8 xl:px-12 lg:mt-2 xl:mt-10"
      >
        {authstate === "Sign Up" && (
          <div className="flex w-full items-center p-2 border-3 border-black/50 rounded-xl gap-1 text-gray-700 ">
            ...
            <input
              ...
              type="text"
              className="outline-none w-full xl:py-1 px-2 f-poppins"
        ...
        <button
          type="submit"
          className="bg-blue-400 text-xl f-poppins py-2 text-white font-semibold cursor-pointer hover:bg-blue-500 rounded-xl"
        >
          {authstate}
        </button>
      </form>
      <div className="flex items-center text-gray-500 f-inter gap-1 mt-2 font-semibold">
        ...
        <p
          onClick={() => handleStateChange(authstate)}
